...
export class WakaTime {
  ...
  private setResourcesLocation() {
    ...
    try {
      ...
      console.log(this.resourcesLocation)
  ...
  public async promptForApiKey(hidden: boolean = true): Promise<void> {
    ...
    vscode.window.showInputBox(promptOptions).then((val) => {
      ...
      } else vscode.window.setStatusBarMessage('StatTrack api key not provided');
    });
  }
            ...
            if (output) {
              ...
              if (jsonData?.text) {
                ...
                this.updateStatusBarTooltip(
                  'StatTrack: Calculating time spent today in background...',
                );
              }
